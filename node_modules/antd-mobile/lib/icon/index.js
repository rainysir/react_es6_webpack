...
Icon=function(_React$Component){(0,_inherits3["default"])(Icon,_React$Component);function Icon(){(0,_classCallCheck3["default"])(this,Icon);return(0,_possibleConstructorReturn3["default"])(this,_React$Component.apply(this,arguments));}Icon.prototype.
render=function render(){var _props=
this.props,size=_props.size,type=_props.type,color=_props.color;
...
return _react2["default"].createElement(_reactNative.Text,{style:TextIconStyle},iconMap[type]||type);
};return Icon;}(_react2["default"].Component);exports["default"]=Icon;

Icon.defaultProps={
size:22,
color:'#000'};module.exports=exports['default'];