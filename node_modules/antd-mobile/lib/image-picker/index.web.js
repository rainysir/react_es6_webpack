...
var _wingBlank=require('../wing-blank');var _wingBlank2=_interopRequireDefault(_wingBlank);
...
var _rcTouchable=require('rc-touchable');var _rcTouchable2=_interopRequireDefault(_rcTouchable);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{"default":obj};}var __assign=undefined&&undefined.__assign||Object.assign||function(t){for(var s,i=1,n=arguments.length;i<n;i++){s=arguments[i];for(var p in s){if(Object.prototype.hasOwnProperty.call(s,p))t[p]=s[p];}}return t;};
function noop(){}var
...
_this.getRotation=function(){var orientation=arguments.length>0&&arguments[0]!==undefined?arguments[0]:1;
var imgRotation=0;
switch(orientation){
case 3:
imgRotation=180;
...
var curStyle=__assign({},itemStyle,{transform:'rotate('+_this2.getRotation(image.orientation)+'deg)'});
imgItemList.push(_react2["default"].createElement('div',{key:index,className:prefixCls+'-item',style:curStyle},
_react2["default"].createElement('div',{className:prefixCls+'-item-remove',onClick:function onClick(){_this2.removeImage(index);}}),
_react2["default"].createElement('div',{className:prefixCls+'-item-content',onClick:function onClick(){_this2.onImageClick(index);},style:{backgroundImage:'url('+image.url+')'}})));

});
var selectEl=_react2["default"].createElement(_rcTouchable2["default"],{activeClassName:prefixCls+'-upload-btn-active'},
_react2["default"].createElement('div',{className:prefixCls+'-item '+prefixCls+'-upload-btn',style:itemStyle,onClick:onAddImageClick},
_react2["default"].createElement('input',{style:itemStyle,ref:'fileSelectorInput',type:'file',accept:'image/jpg,image/jpeg,image/png,image/gif',onChange:function onChange(){_this2.onFileChange();}})));


return _react2["default"].createElement('div',{className:wrapCls,style:style},
_react2["default"].createElement('div',{className:prefixCls+'-list'},
_react2["default"].createElement(_wingBlank2["default"],{size:'md'},
_react2["default"].createElement(_flex2["default"],{wrap:'wrap'},
imgItemList,
selectable&&selectEl))));
...
selectable:true};module.exports=exports['default'];